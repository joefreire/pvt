...
use \Carbon\Carbon;
class LinkagemSim extends Model implements Auditable
{
	...
	public function getTipoFalsoAttribute($value)
	{
		return $this->ParVerdadeiro == 1 ? '' : $this->TipoFalso;
	}

	public function sim()
	{
		return $this->HasOne(Sim::class, 'id', 'idUploadSIM');
	}
