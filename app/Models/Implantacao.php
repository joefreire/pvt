...
class Implantacao extends Model implements Auditable
{
	...
	{
		return $this->HasMany(Instituicoes::class, 'idSalva', 'id')->where('TABELA','IMPLANTACAO');
	}
