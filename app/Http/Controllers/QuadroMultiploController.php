	...
	public function saveQuadroMultiplo(Request $request)
	{
		...
		$FatoresRisco = FatoresRisco::updateOrCreate(
			...
			[
				...
				'PreferenciaPedestre' => $request->PreferenciaPedestre,
				...
				'ImprudenciaPedestre' => $request->ImprudenciaPedestre,
				...
				'CintoSeguranca' => $request->CintoSeguranca,
				'UsuarioContributivo_CintoSeguranca' => $request->CintoSeguranca > 0 ? $request->UsuarioContributivo_CintoSeguranca : null,
				'EquipamentoProtecao' => $request->EquipamentoProtecao,
				'GerenciamentoTrauma' => $request->GerenciamentoTrauma,
				'ObjetosLateraisVia' => $request->ObjetosLateraisVia,
				'Capacete' => $request->Capacete,
				'UsuarioContributivo_Capacete' => $request->Capacete > 0 ? $request->UsuarioContributivo_Capacete : null,
				'outra_protecao' => $request->outra_protecao,
